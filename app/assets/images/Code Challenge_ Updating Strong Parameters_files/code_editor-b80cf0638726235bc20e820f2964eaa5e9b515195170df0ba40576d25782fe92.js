!function(e) {
  ...
  function e(r, n) {
    ...
    var s = this;
    for (var u in bo && xo < 11 && setTimeout(function() {
    ...
    ta) ta.hasOwnProperty(u) && ta[u](this, n[u], ra);
  ...
  function i(e) {
    e.options.lineWrapping ? (el(e.display.wrapper, "CodeMirror-wrap"), e.display.sizer.style.minWidth = "", 
    e.display.sizerWidth = null) : (Ja(e.display.wrapper, "CodeMirror-wrap"), f(e)), 
  ...
  function d(e) {
    ...
    for (var t, r = e.text.length, n = e; t = mn(n); ) {
      n = (i = t.find(0, !0)).from.line, r += i.from.ch - i.to.ch;
    }
    for (n = e; t = gn(n); ) {
      var i = t.find(0, !0);
      r -= n.text.length - i.from.ch, r += (n = i.to.line).text.length - i.to.ch;
    }
    return r;
  }
  function f(e) {
  ...
  function g() {}
  function v(t) {
    t.display.scrollbars && (t.display.scrollbars.clear(), t.display.scrollbars.addClass && Ja(t.display.wrapper, t.display.scrollbars.addClass)), 
    ...
    }, t), t.display.scrollbars.addClass && el(t.display.wrapper, t.display.scrollbars.addClass);
  }
  function y(e, t) {
    t || (t = h(e));
  ...
  function j(e, t, r, n) {
    ...
    if (e.options.lineNumbers || o) {
      i = I(t);
      var a = t.gutter = Bi("div", null, "CodeMirror-gutter-wrapper", "left: " + (e.options.fixedGutter ? n.fixedPos : -n.gutterTotalWidth) + "px");
  ...
  function se(e, t, r) {
    ...
    var h = s.previousSibling;
    for (p = r; h; h = h.previousSibling) {
  ...
  function Ze(e, t, r) {
    ...
    for (n = 0; n < e.rest.length; n++) if (ti(e.rest[n]) > r) return {
      map: e.measure.maps[n],
      cache: e.measure.caches[n],
      before: !0
    };
  ...
  function Ye(e, t) {
    var r = ti(t = yn(t)), n = e.display.externalMeasured = new Wt(e.doc, t, r);
    n.lineN = r;
  ...
  function tt(e, t, r, n, i) {
    ...
    t.hasHeights || (Xe(e, t.view, t.rect), t.hasHeights = !0), (o = nt(e, t, r, n)).bogus || (t.cache[a] = o)), 
    {
      left: o.left,
      right: o.right,
      top: i ? o.rtop : o.top,
  ...
  function rt(e, t, r) {
    for (var n, i, o, a, l = 0; l < e.length; l += 3) {
      var s = e[l], c = e[l + 1];
      if (t < s ? (i = 0, o = 1, a = "left") : t < c ? o = (i = t - s) + 1 : (l == e.length - 3 || t == c && e[l + 3] > t) && (i = (o = c - s) - 1, 
      t >= c && (a = "right")), null != i) {
  ...
  function nt(e, t, r, n) {
    ...
    if (3 == a.nodeType) {
      for (var u = 0; u < 4; u++) {
        ...
        if (bo && xo < 9 && 0 == l && s == o.coverEnd - o.coverStart) i = a.parentNode.getBoundingClientRect(); else if (bo && e.options.lineWrapping) {
          i = (d = Ua(a, l, s).getClientRects()).length ? d["right" == n ? d.length - 1 : 0] : Uo;
    ...
    var p = i.top - t.rect.top, h = i.bottom - t.rect.top, m = (p + h) / 2, g = t.view.measure.heights;
  ...
  function pt(e, t, r, n, i, o) {
    ...
    function l(e, t) {
      ...
      return e == to(r) && t && r.level < s[t - 1].level ? (e = ro(r = s[--t]) - (r.level % 2 ? 0 : 1), 
      n = !0) : e == ro(r) && t < s.length - 1 && r.level < s[t + 1].level && (e = to(r = s[++t]) - r.level % 2, 
      n = !1), n && e == r.to && e > r.from ? a(e - 1) : a(e, n);
    }
    n = n || Yn(e.doc, t.line), i || (i = et(e, n));
    var s = ii(n), c = t.ch;
    if (!s) return a(c);
    var u = l(c, co(s, c));
    return null != Qa && (u.other = l(c, Qa)), u;
  }
  function ht(e, t) {
    var r = 0;
    t = me(e.doc, t);
  ...
  function _t(e) {
    ...
    if (t) try {
      ...
      Ko = null;
      for (var r = 0; r < t.ops.length; r++) t.ops[r].cm.curOp = null;
      kt(t);
    }
  }
  function kt(e) {
    for (var t = e.ops, r = 0; r < t.length; r++) Ct(t[r]);
    for (r = 0; r < t.length; r++) St(t[r]);
    for (r = 0; r < t.length; r++) Mt(t[r]);
    for (r = 0; r < t.length; r++) Lt(t[r]);
    for (r = 0; r < t.length; r++) Tt(t[r]);
  }
  function Ct(e) {
  ...
  function Tt(e) {
    ...
    if (a) for (l = 0; l < a.length; ++l) a[l].lines.length && Wa(a[l], "unhide");
  ...
  function qt(e, t, r, n) {
    ...
    i.viewTo += n); else if (t <= i.viewFrom && r >= i.viewTo) Et(e); else if (t <= i.viewFrom) {
      (o = Ht(e, r, r + n, 1)) ? (i.view = i.view.slice(o.index), i.viewFrom = o.lineN, 
      i.viewTo += n) : Et(e);
    } else if (r >= i.viewTo) {
      var o;
      (o = Ht(e, t, t, -1)) ? (i.view = i.view.slice(0, o.index), i.viewTo = o.lineN) : Et(e);
    } else {
  ...
  function Bt(e) {
    ...
    var i = e.display;
    Aa(i.scroller, "mousedown", At(e, $t)), Aa(i.scroller, "dblclick", bo && xo < 11 ? At(e, function(t) {
      if (!Mi(e, t)) {
        var r = Vt(e, t);
  ...
  function $t(e) {
    ...
    if (!(Mi(t, e) || r.activeTouch && r.input.supportsTouch())) if (r.shift = e.shiftKey, 
    Kt(r, e)) wo || (r.scroller.draggable = !1, setTimeout(function() {
  ...
  function Gt(e, t, r) {
    ...
    e.options.dragDrop && rl && !e.isReadOnly() && "single" == n && (o = a.contains(r)) > -1 && (Ho((o = a.ranges[o]).from(), r) < 0 || r.xRel > 0) && (Ho(o.to(), r) > 0 || r.xRel < 0) ? Xt(e, t, r, l) : Zt(e, t, r, n, l);
  }
  function Xt(e, t, r, n) {
  ...
  function Zt(e, t, r, n, i) {
    function o(t) {
      if (0 != Ho(g, t)) if (g = t, "rect" == n) {
        ...
        if ("single" != n) {
          if ("double" == n) var _ = e.findWordAt(t); else _ = new de(Po(t.line, 0), me(c, Po(t.line + 1, 0)));
          Ho(_.anchor, x) > 0 ? (w = _.head, x = X(b.from(), _.anchor)) : (w = _.anchor, x = G(b.to(), _.head));
        }
        (i = f.ranges.slice(0))[d] = new de(me(c, x), w), Me(c, fe(i, d), Pa);
      }
    }
    function a(t) {
      ...
      if (r && !t.isReadOnly()) if (n && n.length && window.FileReader && window.File) for (var i = n.length, o = Array(i), a = 0, l = function(e, n) {
        ...
        try {
          if (o = e.dataTransfer.getData("Text")) {
            ...
            if (Le(t.doc, pe(r, r)), c) for (s = 0; s < c.length; ++s) Or(t.doc, "", c[s].anchor, c[s].head, "drag");
  ...
  function er(e, t) {
    if (bo && (!e.state.draggingText || +new Date() - $o < 100)) za(t); else if (!Mi(e, t) && !Kt(e.display, t) && (t.dataTransfer.setData("Text", e.getSelection()), 
  ...
  function dr(e) {
    ...
    if (t.curOp.focus = Ki(), !Mi(t, e)) {
      ...
      var n = cr(t, e);
      Co && (Qo = n ? r : null, !n && 88 == r && !ol && (Ao ? e.metaKey : e.ctrlKey) && t.replaceSelection("", null, "cut")), 
      18 != r || /\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className) || fr(t);
    }
  }
  function fr(e) {
    function t(e) {
      18 != e.keyCode && e.altKey || (Ja(r, "CodeMirror-crosshair"), Na(document, "keyup", t), 
      Na(document, "mouseover", t));
    }
    var r = e.display.lineDiv;
    el(r, "CodeMirror-crosshair"), Aa(document, "keyup", t), Aa(document, "mouseover", t);
  }
  function pr(e) {
  ...
  function hr(e) {
    ...
    if (!(Kt(t.display, e) || Mi(t, e) || e.ctrlKey && !e.altKey || Ao && e.metaKey)) {
      ...
      if (!Co || e.which && !(e.which < 10) || !cr(t, e)) ur(t, e, String.fromCharCode(null == n ? r : n)) || t.display.input.onKeyPress(e);
    }
  }
  function mr(e) {
  ...
  function gr(e) {
    ...
    e.state.focused = !0, el(e.display.wrapper, "CodeMirror-focused"), e.curOp || e.display.selForContextMenu == e.doc.sel || (e.display.input.reset(), 
  ...
  function vr(e) {
    ...
    Ja(e.display.wrapper, "CodeMirror-focused")), clearInterval(e.display.blinker), 
    setTimeout(function() {
  ...
  function Lr(e, t, r) {
    if (!e.cm || !e.cm.state.suppressEdits) {
      ...
      if (s != a.length) {
        ...
        var u = Ti(e, "beforeChange") || e.cm && Ti(e.cm, "beforeChange");
        for (s = n.changes.length - 1; s >= 0; --s) {
          var d = n.changes[s];
  ...
  function zr(e, t, r, n) {
    ...
    if (t.to.line < e.first) Tr(e, t.text.length - 1 - (t.to.line - t.from.line)); else if (!(t.from.line > e.lastLine())) {
  ...
  function Hr(e, t, r, n) {
    ...
    l.stateAfter = null, !0;
    for (p = 0; p < o.sel.ranges.length; p++) {
      var h = o.sel.ranges[p];
      if (h.head.line == t && h.head.ch < u.length) {
        _e(o, p, new de(f = Po(t, u.length), f));
        break;
      }
    }
  }
  ...
  function Kr(e) {
    for (var t, r, n, i, o = e.split(/-(?!$)/), a = (e = o[o.length - 1], 0); a < o.length - 1; a++) {
      var l = o[a];
  ...
  function rn(e, t, r) {
    if (e) for (var n, i = 0; i < e.length; ++i) {
      ...
      if (null == o.from || (a.inclusiveLeft ? o.from <= t : o.from < t) || o.from == t && "bookmark" == a.type && (!r || !o.marker.insertLeft)) {
        ...
        (n || (n = [])).push(new Qr(a, o.from, l ? null : o.to));
      }
    }
    return n;
  }
  function nn(e, t, r) {
    if (e) for (var n, i = 0; i < e.length; ++i) {
      ...
      if (null == o.to || (a.inclusiveRight ? o.to >= t : o.to > t) || o.from == t && "bookmark" == a.type && (!r || o.marker.insertLeft)) {
        ...
        (n || (n = [])).push(new Qr(a, l ? null : o.from - t, null == o.to ? null : o.to - t));
      }
    }
    return n;
  }
  function on(e, t) {
    ...
    if (l) for (var d = 0; d < l.length; ++d) {
      if (null == (f = l[d]).to) (p = Jr(s, f.marker)) ? c && (f.to = null == p.to ? null : p.to + u) : f.to = i;
    }
    if (s) for (d = 0; d < s.length; ++d) {
      var f, p;
      if (null != (f = s[d]).to && (f.to += u), null == f.from) (p = Jr(l, f.marker)) || (f.from = u, 
      c && (l || (l = [])).push(f)); else f.from += u, c && (l || (l = [])).push(f);
    }
    l && (l = an(l)), s && s != l && (s = an(s));
    var h = [ l ];
    if (!c) {
      var m, g = t.text.length - 2;
      if (g > 0 && l) for (d = 0; d < l.length; ++d) null == l[d].to && (m || (m = [])).push(new Qr(l[d].marker, null, null));
      for (d = 0; d < g; ++d) h.push(m);
      h.push(s);
    }
    return h;
  }
  ...
  function hn(e, t) {
    ...
    if (n) for (var i, o = 0; o < n.length; ++o) (i = n[o]).marker.collapsed && null == (t ? i.from : i.to) && (!r || pn(r, i.marker) < 0) && (r = i.marker);
    return r;
  }
  function mn(e) {
    return hn(e, !0);
  ...
  function _n(e, t) {
    ...
    if (r) for (var n, i = 0; i < r.length; ++i) if ((n = r[i]).marker.collapsed) {
  ...
  function kn(e, t, r) {
    ...
    for (var i, o = 0; o < t.markedSpans.length; ++o) if ((i = t.markedSpans[o]).marker.collapsed && !i.marker.widgetNode && i.from == r.to && (null == i.to || i.to != r.from) && (i.marker.inclusiveLeft || r.marker.inclusiveRight) && kn(e, t, i)) return !0;
  }
  function Cn(e, t, r) {
  ...
  function Wn(e, t, r, n, i, o, a) {
    ...
    for ("" == t && zn(An(r, n), o); !d.eol(); ) {
      ...
      if (!l || u != s) {
        for (;c < d.start; ) i(c = Math.min(d.start, c + 5e4), u);
        u = s;
      }
      d.start = d.pos;
    }
  ...
  function Pn(e, t) {
    ...
    for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
      ...
      n.map = [], Un(a, n, qn(e, a, t != e.display.externalMeasured && ti(a))), a.styleClasses && (a.styleClasses.bgClass && (n.bgClass = $i(a.styleClasses.bgClass, n.bgClass || "")), 
  ...
  function Fn(e, t, r, n, i, o, a) {
    if (t) {
      ...
      if (s.test(t)) {
        ...
        for (var u = 0; ;) {
          s.lastIndex = u;
          var d = s.exec(t), f = d ? d.index - u : t.length - u;
          if (f) {
            var p = document.createTextNode(l.slice(u, u + f));
            bo && xo < 9 ? g.appendChild(Bi("span", [ p ])) : g.appendChild(p), e.map.push(e.pos, e.pos + f, p), 
            e.col += f, e.pos += f;
          }
          if (!d) break;
          if (u += f + 1, "\t" == d[0]) {
            var h = e.cm.options.tabSize, m = h - e.col % h;
            (p = g.appendChild(Bi("span", Oi(m), "cm-tab"))).setAttribute("role", "presentation"), 
            p.setAttribute("cm-text", "\t"), e.col += m;
          } else if ("\r" == d[0] || "\n" == d[0]) {
            (p = g.appendChild(Bi("span", "\r" == d[0] ? "\u240d" : "\u2424", "cm-invalidchar"))).setAttribute("cm-text", d[0]), 
            e.col += 1;
          } else {
            (p = e.cm.options.specialCharPlaceholder(d[0])).setAttribute("cm-text", d[0]), bo && xo < 9 ? g.appendChild(Bi("span", [ p ])) : g.appendChild(p), 
            e.col += 1;
          }
        ...
        e.col += t.length;
        var g = document.createTextNode(l);
        e.map.push(e.pos, e.pos + t.length, g), bo && xo < 9 && (c = !0), e.pos += t.length;
      }
      if (r || n || i || c || a) {
        var v = r || "";
        n && (v += n), i && (v += i);
  ...
  function Un(e, t, r) {
    ...
    if (n) for (var a, l, s, c, u, d, f, p = i.length, h = 0, m = (S = 1, ""), g = 0; ;) {
      if (g == h) {
        s = c = u = d = l = "", f = null, g = Infinity;
        for (var v, y = [], b = 0; b < n.length; ++b) {
          var x = n[b], w = x.marker;
          "bookmark" == w.type && x.from == h && w.widgetNode ? y.push(w) : x.from <= h && (null == x.to || x.to > h || w.collapsed && x.to == h && x.from == h) ? (null != x.to && x.to != h && g > x.to && (g = x.to, 
          c = ""), w.className && (s += " " + w.className), w.css && (l = (l ? l + ";" : "") + w.css), 
          w.startStyle && x.from == h && (u += " " + w.startStyle), w.endStyle && x.to == g && (v || (v = [])).push(w.endStyle, x.to), 
          w.title && !d && (d = w.title), w.collapsed && (!f || pn(f.marker, w) < 0) && (f = x)) : x.from > h && g > x.from && (g = x.from);
        }
        if (v) for (b = 0; b < v.length; b += 2) v[b + 1] == g && (c += " " + v[b]);
        if (!f || f.from == h) for (b = 0; b < y.length; ++b) Rn(t, 0, y[b]);
        if (f && (f.from || 0) == h) {
      ...
      for (var _ = Math.min(p, g); ;) {
        if (m) {
          var k = h + m.length;
          if (!f) {
            var C = k > _ ? m.slice(0, _ - h) : m;
            t.addToken(t, C, a ? a + s : s, u, h + C.length == g ? c : "", d, l);
          }
          if (k >= _) {
            m = m.slice(_ - h), h = _;
            break;
        ...
        m = i.slice(o, o = r[S++]), a = En(r[S++], t.cm.options);
      }
    } else for (var S = 1; S < r.length; S += 2) t.addToken(t, i.slice(o, o = r[S]), En(r[S + 1], t.cm.options));
  }
  function Kn(e, t) {
  ...
  function Vn(e, t, r, n) {
    ...
    if (t.full) e.insert(0, a(0, c.length)), e.remove(c.length, e.size - c.length); else if (Kn(e, t)) {
      ...
      if (1 == c.length) o(u, u.text.slice(0, l.ch) + f + u.text.slice(s.ch), p); else (m = a(1, c.length - 1)).push(new xa(f + u.text.slice(s.ch), p, n)), 
      o(u, u.text.slice(0, l.ch) + c[0], i(0)), e.insert(l.line + 1, m);
  ...
  function ni(e) {
    for (var t = 0, r = (e = yn(e)).parent, n = 0; n < r.lines.length; ++n) {
      var i = r.lines[n];
      if (i == e) break;
      t += i.height;
    }
    for (var o = r.parent; o; o = (r = o).parent) for (n = 0; n < o.children.length; ++n) {
      var a = o.children[n];
      if (a == r) break;
      t += a.height;
    }
  ...
  function ii(e) {
    var t = e.order;
    return null == t && (t = e.order = sl(e.text)), t;
  }
  function oi(e) {
  ...
  function Ii(e, t) {
    var r;
    return Object.create ? r = Object.create(e) : (qi.prototype = e, r = new qi()), 
    t && Ei(t, r), r;
  }
  function Ei(e, t, r) {
  ...
  function Ji(e) {
    ...
    return al = Math.abs(r.left - n.left) > 1;
  }
  function eo(e, t, r, n) {
  ...
  function co(e, t) {
    ...
    for (var r, n = 0; n < e.length; ++n) {
      ...
      if (i.from == t || i.to == t) {
        if (null != r) return so(e, i.level, e[r].level) ? (i.from != i.to && (Qa = r), 
        n) : (i.from != i.to && (Qa = n), r);
        r = n;
      }
    }
    return r;
  ...
  function fo(e, t, r, n) {
    ...
    for (var o = co(i, t), a = i[o], l = uo(e, t, a.level % 2 ? -r : r, n); ;) {
      ...
      if (l == a.from || l == a.to) return co(i, l) == o ? l : r > 0 == (a = i[o += r]).level % 2 ? a.to : a.from;
  ...
  re.prototype = Ei({
    ...
    showSelection: function(e) {
      ...
      Ui(t.cursorDiv, e.cursors), Ui(t.selectionDiv, e.selection), null != e.teTop && (this.wrapper.style.top = e.teTop + "px", 
    ...
    reset: function(e) {
      if (!this.contextMenuPending) {
        ...
        if (n.somethingSelected()) {
          this.prevInput = "";
          var o = i.sel.primary(), a = (t = ol && (o.to().line - o.from().line > 100 || (r = n.getSelection()).length > 1e3)) ? "-" : r || n.getSelection();
    ...
    poll: function() {
      ...
      if (this.contextMenuPending || !e.state.focused || il(t) && !r && !this.composing || e.isReadOnly() || e.options.disableInput || e.state.keySeq) return !1;
      var n = t.value;
    ...
    init: function(e) {
      ...
      te(i), Aa(i, "paste", function(e) {
        ...
        if (r.composing = {
          ...
          var i = n.doc.sel.primary(), o = n.getLine(i.head.line).indexOf(t, Math.max(0, i.head.ch - t.length));
          o > -1 && o <= i.head.ch && (r.composing.sel = pe(Po(i.head.line, o), Po(i.head.line, o + t.length)));
        }
    ...
    pollContent: function() {
      ...
      if (i.line == r.viewFrom || 0 == (e = Pt(t, i.line))) var a = ti(r.view[0].line), l = r.view[0].node; else a = ti(r.view[e].line), 
      l = r.view[e - 1].node.nextSibling;
      var s = Pt(t, o.line);
      if (s == r.view.length - 1) var c = r.viewTo - 1, u = r.lineDiv.lastChild; else c = ti(r.view[s + 1].line) - 1, 
      u = r.view[s + 1].node.previousSibling;
      for (var d = t.doc.splitLines(ce(t, l, u, a, c)), f = Qn(t.doc, Po(a, 0), Po(c, Yn(t.doc, c).text.length)); d.length > 1 && f.length > 1; ) if (Ni(d) == Ni(f)) d.pop(), 
      f.pop(), c--; else {
        if (d[0] != f[0]) break;
        d.shift(), f.shift(), a++;
      }
      ...
      return d.length > 1 || d[0] || Ho(w, _) ? (Or(t.doc, d, w, _, "+input"), !0) : void 0;
    },
    ensurePolled: function() {
  ...
  e.prototype = {
    ...
    getStateAfter: function(e, t) {
      var r = this.doc;
      return Be(this, (e = he(r, null == e ? r.first + r.size - 1 : e)) + 1, t);
    },
    cursorCoords: function(e, t) {
      var r = this.doc.sel.primary();
      return pt(this, null == e ? r.head : "object" == typeof e ? me(this.doc, e) : e ? r.from() : r.to(), t || "page");
    },
    charCoords: function(e, t) {
      return ft(this, me(this.doc, e), t || "page");
    },
    coordsChar: function(e, t) {
      return gt(this, (e = dt(this, e, t || "page")).left, e.top);
    },
    ...
    addWidget: function(e, t, r, n, i) {
      var o = this.display, a = (e = pt(this, me(this.doc, e))).bottom, l = e.left;
    ...
    findPosH: function(e, t, r, n) {
      var i = 1;
      t < 0 && (i = -1, t = -t);
      for (var o = 0, a = me(this.doc, e); o < t && !(a = Br(this.doc, a, i, r, n)).hitSide; ++o) ;
      return a;
    },
    ...
    findPosV: function(e, t, r, n) {
      ...
      for (var a = 0, l = me(this.doc, e); a < t; ++a) {
        var s = pt(this, l, "div");
        if (null == o ? o = s.left : s.left = o, (l = Rr(this, s, i, r)).hitSide) break;
      }
      return l;
    },
    ...
    findWordAt: function(e) {
      var t = Yn(this.doc, e.line).text, r = e.ch, n = e.ch;
      if (t) {
        var i = this.getHelper(e, "wordChars");
        (e.xRel < 0 || n == t.length) && r ? --r : ++n;
        for (var o = t.charAt(r), a = Hi(o, i) ? function(e) {
          return Hi(e, i);
        } : /\s/.test(o) ? function(e) {
          return /\s/.test(e);
        } : function(e) {
      ...
      return new de(Po(e.line, r), Po(e.line, n));
    },
    toggleOverwrite: function(e) {
      null != e && e == this.state.overwrite || ((this.state.overwrite = !this.state.overwrite) ? el(this.display.cursorDiv, "CodeMirror-overwrite") : Ja(this.display.cursorDiv, "CodeMirror-overwrite"), 
  ...
  Ur("tabSize", 4, function(e) {
    ...
    t.state.specialChars = new RegExp(r.source + (r.test("\t") ? "" : "|\t"), "g"), 
    n != e.Init && t.refresh();
  ...
  var fa = e.lookupKey = function(e, t, r, n) {
    var i = (t = Vr(t)).call ? t.call(e, n) : t[e];
  ...
  e.fromTextArea = function(t, r) {
    ...
    if ((r = r ? Ei(r) : {}).value = t.value, !r.tabindex && t.tabIndex && (r.tabindex = t.tabIndex), 
  ...
  ma.prototype = {
    ...
    eat: function(e) {
      ...
      if ("string" == typeof e) var r = t == e; else r = t && (e.test ? e.test(t) : e(t));
  ...
  $n.prototype = {
    ...
    maybeSpill: function() {
      if (!(this.children.length <= 10)) {
        var e = this;
        do {
          var t = new Gn(e.children.splice(e.children.length - 5, 5));
          if (e.parent) {
            e.size -= t.size, e.height -= t.height;
            var r = Wi(e.parent.children, e);
            e.parent.children.splice(r + 1, 0, t);
          } else {
            var n = new Gn(e.children);
  ...
  Ca.prototype = Ii(Gn.prototype, {
    ...
    replaceRange: function(e, t, r, n) {
      Or(this, e, t = me(this, t), r = r ? me(this, r) : t, n);
    },
    ...
    replaceSelections: Nt(function(e, t, r) {
      ...
      var l = t && "end" != t && kr(this, n, t);
      for (o = n.length - 1; o >= 0; o--) Sr(this, n[o]);
    ...
    setBookmark: function(e, t) {
      ...
      return $r(this, e = me(this, e), e, r, "bookmark");
    },
    findMarksAt: function(e) {
      var t = [], r = Yn(this, (e = me(this, e)).line).markedSpans;
    ...
    unlinkDoc: function(t) {
      ...
      if (t.history == this.history) {
        ...
        Xn(t, function(e) {
          n.push(e.id);
        }, !0), t.history = new oi(null), t.history.done = gi(this.history.done, n), t.history.undone = gi(this.history.undone, n);
      }
    },
  ...
  }, ol = "oncopy" in (Ya = Bi("div")) || (Ya.setAttribute("oncopy", "return;"), "function" == typeof Ya.oncopy), al = null, ll = e.keyNames = {
    3: "Enter",
    8: "Backspace",
    9: "Tab",
    13: "Enter",
  ...
  !function() {
    for (var e = 0; e < 10; e++) ll[e + 48] = ll[e + 96] = String(e);
    for (e = 65; e <= 90; e++) ll[e] = String.fromCharCode(e);
    for (e = 1; e <= 12; e++) ll[e + 111] = ll[e + 63235] = "F" + e;
  }();
  var sl = function() {
    function e(e) {
    ...
    return function(r) {
      ...
      for (var n = r.length, u = [], d = 0; d < n; ++d) u.push(v = e(r.charCodeAt(d)));
      d = 0;
      for (var f = c; d < n; ++d) {
        "m" == (v = u[d]) ? u[d] = f : f = v;
      }
      d = 0;
      for (var p = c; d < n; ++d) {
        "1" == (v = u[d]) && "r" == p ? u[d] = "n" : a.test(v) && (p = v, "r" == v && (u[d] = "R"));
      }
      for (d = 1, f = u[0]; d < n - 1; ++d) {
        "+" == (v = u[d]) && "1" == f && "1" == u[d + 1] ? u[d] = "1" : "," != v || f != u[d + 1] || "1" != f && "n" != f || (u[d] = f), 
        f = v;
      }
      for (d = 0; d < n; ++d) {
        if ("," == (v = u[d])) u[d] = "N"; else if ("%" == v) {
          for (var h = d + 1; h < n && "%" == u[h]; ++h) ;
          for (var m = d && "!" == u[d - 1] || h < n && "1" == u[h] ? "1" : "N", g = d; g < h; ++g) u[g] = m;
          d = h - 1;
        }
      }
      for (d = 0, p = c; d < n; ++d) {
        var v = u[d];
        "L" == p && "1" == v ? u[d] = "L" : a.test(v) && (p = v);
      }
      for (d = 0; d < n; ++d) if (o.test(u[d])) {
        for (h = d + 1; h < n && o.test(u[h]); ++h) ;
        var y = "L" == (d ? u[d - 1] : c), b = "L" == (h < n ? u[h] : c);
        for (m = y || b ? "L" : "R", g = d; g < h; ++g) u[g] = m;
        d = h - 1;
      }
      var x, w = [];
      for (d = 0; d < n; ) if (l.test(u[d])) {
        var _ = d;
        for (++d; d < n && l.test(u[d]); ++d) ;
        w.push(new t(0, _, d));
      } else {
        var k = d, C = w.length;
        for (++d; d < n && "L" != u[d]; ++d) ;
        for (g = k; g < d; ) if (s.test(u[g])) {
          k < g && w.splice(C, 0, new t(1, k, g));
          var S = g;
          for (++g; g < d && s.test(u[g]); ++g) ;
          w.splice(C, 0, new t(2, S, g)), k = g;
        } else ++g;
        k < d && w.splice(C, 0, new t(1, k, d));
      }
      return 1 == w[0].level && (x = r.match(/^\s+/)) && (w[0].from = x[0].length, w.unshift(new t(0, 0, x[0].length))), 
      1 == Ni(w).level && (x = r.match(/\s+$/)) && (Ni(w).to -= x[0].length, w.push(new t(0, n - x[0].length, n))), 
      2 == w[0].level && w.unshift(new t(1, w[0].to, w[0].to)), w[0].level != Ni(w).level && w.push(new t(w[0].level, n, n)), 
      w;
    };
  }();
    ...
    return {
      ...
      token: function(i, o) {
        ...
        for (var s = Infinity, c = i.string, u = 0; u < n.length; ++u) {
          var d, f = n[u];
          if ((d = r(c, f.open, i.pos)) == i.pos) return f.parseDelimiters || i.match(f.open), 
          o.innerActive = f, o.inner = e.startState(f.mode, t.indent ? t.indent(o.outer, "") : 0), 
          f.delimStyle && f.delimStyle + " " + f.delimStyle + "-open";
          -1 != d && d < s && (s = d);
        }
        s != Infinity && (i.string = c.slice(0, s));
        var p = t.token(i, o.outer);
        return s != Infinity && (i.string = c), p;
      },
      indent: function(r, n) {
  ...
  e.defineMode("ruby", function(e) {
    ...
    return {
      ...
      token: function(e, t) {
        ...
        if ("ident" == n) {
          var o = e.current();
          "keyword" == (n = "." == t.lastTok ? "property" : u.propertyIsEnumerable(e.current()) ? "keyword" : /^[A-Z]/.test(o) ? "tag" : "def" == t.lastTok || "class" == t.lastTok || t.varList ? "def" : "variable") && (i = o, 
  ...
  e.defineMode("xml", function(n, i) {
    function o(e, t) {
      ...
      "meta") : (_ = e.eat("/") ? "closeTag" : "openTag", t.tokenize = a, "tag bracket") : "&" == n ? (e.eat("#") ? e.eat("x") ? e.eatWhile(/[a-fA-F\d]/) && e.eat(";") : e.eatWhile(/[\d]/) && e.eat(";") : e.eatWhile(/[\w\.\-:]/) && e.eat(";")) ? "atom" : "error" : (e.eatWhile(/[^&<]/), 
      null);
    }
    function a(e, t) {
      var r = e.next();
      if (">" == r || "/" == r && e.eat(">")) return t.tokenize = o, _ = ">" == r ? "endTag" : "selfcloseTag", 
      "tag bracket";
    ...
    function h(e, t, r) {
      return "word" == e ? (r.tagName = t.current(), k = "tag", y) : (k = "error", h);
    }
    function m(e, t, r) {
      if ("word" == e) {
        var n = t.current();
        return r.context && r.context.tagName != n && S.implicitlyClosed.hasOwnProperty(r.context.tagName) && d(r), 
        r.context && r.context.tagName == n || !1 === S.matchClosing ? (k = "tag", g) : (k = "tag error", 
        v);
      }
      return k = "error", v;
    }
    function g(e, t, r) {
      return "endTag" != e ? (k = "error", g) : (d(r), p);
    }
    function v(e, t, r) {
      return k = "error", g(e, t, r);
    }
    function y(e, t, r) {
      if ("word" == e) return k = "attribute", b;
    ...
    function b(e, t, r) {
      return "equals" == e ? x : (S.allowMissing || (k = "error"), y(e, t, r));
    }
    function x(e, t, r) {
      return "string" == e ? w : "word" == e && S.allowUnquoted ? (k = "string", y) : (k = "error", 
      y(e, t, r));
    }
    function w(e, t, r) {
      return "string" == e ? w : y(e, t, r);
    }
    var _, k, C = n.indentUnit, S = {}, M = i.htmlMode ? t : r;
    ...
    return o.isInText = !0, {
      ...
      token: function(e, t) {
        ...
        _ = null;
        var r = t.tokenize(e, t);
        return (r || _) && "comment" != r && (k = null, t.state = t.state(_ || r, e, t), 
        k && (r = "error" == k ? r + " error" : k)), r;
      },
  ...
  e.registerHelper("hintWords", "python", i.concat(o)), e.defineMode("python", function(a, l) {
    ...
    if (k) {
      ...
      C = l.singleOperators || /^[\+\-\*\/%&|\^~<>!]/, S = l.identifiers || /^[_A-Za-z][_A-Za-z0-9]*/;
...
//# sourceMappingURL=/assets/maps/code_editor-98c68cec254d9dd869cc3566e421ae8996069920f1acfbff2fa9715be869308e.js.map
